...
public class Player {
    ...
    /**
     * player constructor to assign number and new lists
    ...
    /**
     * @return the usableCard
     */
    public Card getUsableCard(int n) {
        return usableCards.get(n);
    }
    /**
    ...
    public int selectRandomCard(){
        Random r = new Random();
        int ranNum = r.nextInt(usableCards.size());
        return ranNum;
    }
}