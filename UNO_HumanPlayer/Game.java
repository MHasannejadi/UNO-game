...
public class Game {
    ...
    public void addPlayers(){
        ...
        for(int i = 0 ; i<n ; i++){
            ...
            Player player = new Player(obj.next());
            players.add(player);
            System.out.println();
        }
    }
     ...
     * @return player name
     */
    public String getPlayerName(int score) {
    ...
    public void showResult(){
        ...
        for(int score : scores){
            System.out.println(getPlayerName(score)+": "+score);
        }
    }
    /**
    ...
    public void show(){
        ...
        System.out.println();
        System.out.println("turn: "+nowPlayer.getName());
        System.out.println();
        ...
        int cont = 1;
        for(Player player : players){
            System.out.println(cont+". "+player.getName()+" has "+player.getPlayersCardNum()+" cards.");
            cont++;
        }
        System.out.println();
    }
        ...
        try{
            ...
            while(!checkend()){
                ...
                if(nowPlayer.hasUsableCard()){
                    System.out.print("Hey << "+nowPlayer.getName()+" >> select a card with number: ");
